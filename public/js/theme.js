...
function layout_change_default() {
  ...
  let dark_layout = window.matchMedia("(prefers-color-scheme: dark)").matches
    ? "dark"
    : "light";
  ...
  const btn_control = document.querySelector(
...
function layout_caption_change(value) {
  ...
  var newActiveButton = document.querySelector(
    `.theme-nav-caption .btn[data-value='${value}']`
  );
  if (newActiveButton) {
...
function main_layout_change(value) {
  ...
  document
    .getElementsByTagName("html")[0]
    .setAttribute("data-pc-layout", value);
  ...
  if (control) {
    ...
    var newActiveLink = document.querySelector(
      ".theme-main-layout > a[data-value='" + value + "']"
    );
    if (newActiveLink) {
...
function layout_rtl_change(value) {
  ...
  if (value === "true") {
    ...
    var rtlButton = document.querySelector(
    ...
    var ltrButton = document.querySelector(
...
function layout_change(layout) {
  ...
  var logoSrc = isDark ? "/images/logo.png" : "/images/logo.png";
...
function change_box_container(value) {
  ...
  if (contentElement && footerElement) {
    ...
    var newActiveButton = document.querySelector(
      `.theme-container .btn[data-value='${value}']`
    );
    if (newActiveButton) {
      newActiveButton.classList.add("active");
    }
...
function layout_theme_sidebar_change(value) {
  if (value == "true") {
    document
      .getElementsByTagName("html")[0]
      .setAttribute("data-pc-sidebar_theme", "true");
    ...
    if (control) {
      document
        .querySelector(".theme-nav-layout .btn.active")
        .classList.remove("active");
      document
        .querySelector(".theme-nav-layout .btn[data-value='true']")
        .classList.add("active");
    }
  } else {
    document
      .getElementsByTagName("html")[0]
      .setAttribute("data-pc-sidebar_theme", "false");
    if (document.querySelector(".pc-sidebar .m-header .logo-lg")) {
      document
        .querySelector(".pc-sidebar .m-header .logo-lg")
    ...
    if (control) {
      document
        ...
        .classList.remove("active");
      document
        .querySelector(".theme-nav-layout .btn[data-value='false']")
        .classList.add("active");
    }
  }
}
function header_change(value) {
  document
    .getElementsByTagName("html")[0]
    .setAttribute("data-pc-header", value);
  var control = document.querySelector(".pct-offcanvas");
  if (control) {
    document
      .querySelector(".header-color > a.active")
      .classList.remove("active");
    document
      .querySelector(".header-color > a[data-value='" + value + "']")
      .classList.add("active");
  }
}
function navbar_change(value) {
  document
    .getElementsByTagName("html")[0]
    .setAttribute("data-pc-navbar", value);
  var control = document.querySelector(".pct-offcanvas");
  if (control) {
    document
      .querySelector(".navbar-color > a.active")
      .classList.remove("active");
    document
      .querySelector(".navbar-color > a[data-value='" + value + "']")
      .classList.add("active");
  }
}
function logo_change(value) {
  ...
  if (control) {
    ...
    document
      .querySelector(".logo-color > a[data-value='" + value + "']")
      .classList.add("active");
  }
}
function caption_change(value) {
  document
    .getElementsByTagName("html")[0]
    .setAttribute("data-pc-caption", value);
  var control = document.querySelector(".pct-offcanvas");
  if (control) {
    document
      .querySelector(".caption-color > a.active")
      .classList.remove("active");
    document
      .querySelector(".caption-color > a[data-value='" + value + "']")
      .classList.add("active");
  }
}
function drp_menu_icon_change(value) {
  document
    .getElementsByTagName("html")[0]
    .setAttribute("data-pc-drp-menu-icon", value);
  var control = document.querySelector(".pct-offcanvas");
  if (control) {
    document
      .querySelector(".drp-menu-icon > a.active")
      .classList.remove("active");
    document
      .querySelector(".drp-menu-icon > a[data-value='" + value + "']")
      .classList.add("active");
  }
}
function drp_menu_link_icon_change(value) {
  document
    .getElementsByTagName("html")[0]
    .setAttribute("data-pc-drp-menu-link-icon", value);
  var control = document.querySelector(".pct-offcanvas");
  if (control) {
    document
      .querySelector(".drp-menu-link-icon > a.active")
      .classList.remove("active");
    document
      .querySelector(".drp-menu-link-icon > a[data-value='" + value + "']")
      .classList.add("active");
  }
}
function nav_image_change(value) {
  document
    .getElementsByTagName("html")[0]
    .setAttribute("data-pc-navimg", value);
  var control = document.querySelector(".pct-offcanvas");
  if (control) {
    document.querySelector(".navbar-img > a.active").classList.remove("active");
    document
      .querySelector(".navbar-img > a[data-value='" + value + "']")
      .classList.add("active");
  }
}
