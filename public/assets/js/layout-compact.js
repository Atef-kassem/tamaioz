...
(function () {
  document
    ...
    .setAttribute("data-pc-layout", "compact");
  ...
  if (sidebar_hide) {
    sidebar_hide.addEventListener("click", function () {
      if (
        document.querySelector("body").classList.contains("pc-sidebar-hide")
      ) {
  ...
  for (var i = 0; i < pc_link_click.length; i++) {
    ...
    pc_link_click[i].addEventListener("click", function (event) {
      document
        ...
        .classList.add("pc-compact-submenu-active");
      ...
      if (!targetElement.parentNode.classList.contains("pc-trigger")) {
        document
          .querySelector(".pc-sidebar")
          .classList.remove("pc-compact-submenu-active");
        document
          .querySelector("body")
          .classList.remove("pc-compact-submenu-active");
      } else {
  ...
  for (var l = 0; l < elem.length; l++) {
    ...
    if (elem[l].href == pageUrl && elem[l].getAttribute("href") != "") {
      ...
      elem[
        l
      ].parentNode.parentNode.parentNode.parentNode.parentNode.classList.remove(
        "pc-trigger"
      );
    }
  }
